  ...
  \begin{tikzpicture}
    \begin{groupplot}[
      ...
      \addplot[color=brown,
        ...
        skip coords between index={0}{1423},
        skip coords between index={2748}{4319}
        ] table [x index=0, y index=2]{./inc/sim/QuintaParte.txt};
      \addplot[color=green, 
...
%      %skip coords between index={0}{291},
%      skip coords between index={291}{1196}
%      ] table [x index=0, y index=1]{./inc/sim/OctaveParte.txt};
%    \addplot[thick,color=blue, mark={square},mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{291},
%      skip coords between index={670}{1196}
%      ] table [x index=0, y index=1]{./inc/sim/OctaveParte.txt};
...
%      %skip coords between index={0}{291},
%      skip coords between index={291}{1196},
%      ] table [x index=0, y expr=\thisrowno{2}-\thisrowno{3}]{./inc/sim/OctaveParte.txt};
%    \addplot[thick,color=blue, mark={square},mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{291},
%      skip coords between index={670}{1196},
%      ] table [x index=0, y expr=\thisrowno{2}-\thisrowno{3}]{./inc/sim/OctaveParte.txt};
...
%      %skip coords between index={0}{291},
%      skip coords between index={291}{1196},
%      ] table [x index=0, y index=3]{./inc/sim/OctaveParte.txt};
%    \addplot[thick,color=blue, mark={square},mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{291},
%      skip coords between index={670}{1196},
%      ] table [x index=0, y index=3]{./inc/sim/OctaveParte.txt};
...
%    \addplot[thick, color=red, mark={triangle},mark repeat=80,mark size=1.5pt,
%      %skip coords between index={0}{291},
%      skip coords between index={269}{1073}
%      ] table [x index=0, y index=1]{./inc/sim/OctaveParteInductor.txt};
%    \addplot[thick,color=blue, mark={square},mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{269},
%      skip coords between index={617}{1073}
%      ] table [x index=0, y index=1]{./inc/sim/OctaveParteInductor.txt};
%    \addplot[thick,color=brown, mark=x,mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{617}
%      ] table [x index=0, y index=1]{./inc/sim/OctaveParteInductor.txt};
%   \legend{
%   $K\rightarrow 1$,
%   $K\rightarrow 0.5$,
...
%      %skip coords between index={0}{291},
%      skip coords between index={269}{1073}
%      ] table [x index=0, y expr=\thisrowno{2}-\thisrowno{3}]{./inc/sim/OctaveParteInductor.txt};
%    \addplot[thick,color=blue, mark={square},mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{269},
%      skip coords between index={617}{1073}
%      ] table [x index=0, y expr=\thisrowno{2}-\thisrowno{3}]{./inc/sim/OctaveParteInductor.txt};
...
%      %skip coords between index={0}{291},
%      skip coords between index={269}{1073}
%      ] table [x index=0, y index=3]{./inc/sim/OctaveParteInductor.txt};
%    \addplot[thick,color=blue, mark={square},mark repeat=80,mark size=1.5pt,
%      skip coords between index={0}{269},
%      skip coords between index={617}{1073}
%      ] table [x index=0, y index=3]{./inc/sim/OctaveParteInductor.txt};
